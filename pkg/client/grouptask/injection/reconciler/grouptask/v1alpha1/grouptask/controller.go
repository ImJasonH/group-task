...
import (
	...
	versionedscheme "github.com/imjasonh/group-task/pkg/client/grouptask/clientset/versioned/scheme"
	client "github.com/imjasonh/group-task/pkg/client/grouptask/injection/client"
...
const (
	defaultControllerAgentName = "grouptask-controller"
	defaultFinalizerName       = "grouptasks.grouptask"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	lister := grouptaskInformer.Lister()
